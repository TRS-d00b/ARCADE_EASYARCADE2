...
基板の状態やケーブルの品質等により、明るさ（Gain）、位相(Phase)、表示位置、ローパスフィルターなどの調整が必要になる場合があります。
RetroTINK-4KのAuto Gain、Auto Phaseを活用してください。
...
Depending on the condition of PCB and quality of cable, it may be necessary to adjust brightness (Gain), phase, display position, low-pass filter, etc.
Please make use of the RetroTINK-4K's Auto Gain and Auto Phase.

Note: Set the EASY ARCADE 2 sync level to the C side (1Vpp). Setting it to the N side (pass-through) may damage the RetroTINK-4K.
